                        ...
                        @foreach($orders as $order)
                            <tr class="odd:bg-white even:bg-gray-100 dark:odd:bg-slate-900 dark:even:bg-slate-800"
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-gray-200"><span
                                        class="{{'bg-'.$order->statusColor().'-500'}} py-1 px-3 rounded text-white shadow">{{$order->status}}</span>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-gray-200"><span
                                        class="{{'bg-'.$order->paymentStatusColor().'-500'}} py-1 px-3 rounded text-white shadow">{{$order->payment_status}}</span>
                                </td>
