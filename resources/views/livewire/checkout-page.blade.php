                    ...
                    <div class="bg-white rounded-xl shadow p-4 sm:p-7 dark:bg-slate-900">
                        ...
                        <div class="mb-6">
                            ...
                            <div class="mt-4">
                                ...
                                <input wire:model="street_address" class="w-full rounded-lg border @error('street_address') border-red-500 @enderror py-2 px-3 dark:bg-gray-700 dark:text-white dark:border-none" id="address" type="text">
                                </input>
                        ...
                        <ul class="grid w-full gap-6 md:grid-cols-2">
                            <li>
                                <input wire:model="payment_method" class="hidden peer" id="hosting-small" value="cache_on_delivery" required="" type="radio" />
                            ...
                            <li>
                                <input wire:model="payment_method" class="hidden peer" id="hosting-big" value="stripe" type="radio">
            ...
            <div class="md:col-span-12 lg:col-span-4 col-span-12">
                <div class="bg-white rounded-xl shadow p-4 sm:p-7 dark:bg-slate-900">
                    ...
                    <div class="flex justify-between mb-2 font-bold">
                        ...
                        <span>
	    					{{\Illuminate\Support\Number::currency($grand_total)}}
	    				</span>
                    </div>
                    <div class="flex justify-between mb-2 font-bold">
	    				<span>
                        ...
                        <span>
	    					{{\Illuminate\Support\Number::currency(0)}}
	    				</span>
                    </div>
                    <div class="flex justify-between mb-2 font-bold">
	    				<span>
                            ...
                            <li class="py-3 sm:py-4" wire:key="{{$item['product_id']}}">
                                <div class="flex items-center">
                                    <div class="flex-shrink-0">
                                        <img alt="{{$item['product_id']}}" class="w-12 h-12 rounded-full" src="{{url('storage',$item['image'])}}">
                                        </img>
                                    </div>
