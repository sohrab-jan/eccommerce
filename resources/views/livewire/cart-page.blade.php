                    ...
                    <table class="w-full">
                        ...
                        @forelse($cartItems as $key=>$item)
                            <tr wire:key="{{$item['product_id']}}">
                                ...
                                <td class="py-4">
                                    <div class="flex items-center">
                                        <button wire:click="decrement({{$item['product_id']}})" class="border rounded-md py-2 px-4 mr-2">-</button>
                                        <span class="text-center w-8">{{$item['quantity']}}</span>
                                        <button wire:click="increment({{$item['product_id']}})" class="border rounded-md py-2 px-4 ml-2">+</button>
                                    </div>
                                </td>
